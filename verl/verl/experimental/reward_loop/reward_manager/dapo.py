...
class DAPORewardManager(RewardManagerBase):
    ...
    async def run_single(self, data: DataProto) -> dict:
        ...
        # Format reward from agent loop: add small reward (0.1) when all tool calls satisfy format constraints
        tool_extra_fields = data_item.non_tensor_batch.get("tool_extra_fields")
        if tool_extra_fields is not None:
            format_reward = tool_extra_fields.get("format_reward", 0.0)
