...
def run_ppo(config, task_runner_class=None) -> None:
    ...
    try:
        ...
        print("\n[Verl] Ctrl+C detected, stopping training and cleaning up Ray resources...")
    except Exception as e:
        print(f"\n[Verl] Unexpected error: {e}")
        raise e  # Re-raise for debugging
    finally:
        # Always shut down Ray on normal or abnormal exit
        if ray.is_initialized():
            print("[Verl] Running ray.shutdown() to clean up worker processes...")
            ray.shutdown()
            print("[Verl] Ray shutdown complete.")
